...
const basePath = '/kolo-mee-stinablis-1775461098526';
...
export default function Home() {
  ...
  const products = [{ n: 'Mee Kolo Putih', d: 'Our signature Mee Kolo Putih is a traditional white curry noodle dish, made with tender noodles, flavorful chicken broth, and a blend of aromatic spices. It is a classic favorite among our customers, and a must-try for any kolo mee enthusiast.', i: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=1200&q=80', icon: 'domain' }, { n: 'Mee Kolo Merah', d: 'Our Mee Kolo Merah is a spicy and savory red curry noodle dish, featuring springy noodles, rich chicken broth, and a kick of chili heat. It is a bold and flavorful twist on the traditional kolo mee recipe.', i: 'https://images.unsplash.com/photo-1519389950473-47ba0277febf?w=1200&q=80', icon: 'architecture' }, { n: 'Mee Kolo Kicap', d: 'Our Mee Kolo Kicap is a sweet and savory soy sauce-based noodle dish, made with thin noodles, caramelized soy sauce, and a hint of sesame oil. It is a comforting and satisfying meal option, perfect for any time of day.', i: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1200&q=80', icon: 'chair' }, { n: 'Wantan', d: 'Our Wantan is a delicious and crispy fried wonton, filled with a savory blend of pork and shrimp, and served with a side of sweet chili sauce. It is a popular snack or appetizer option, and pairs perfectly with our kolo mee dishes.', i: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=1200&q=80', icon: 'eco' }, { n: 'Mee Pok', d: 'Our Mee Pok is a classic flat noodle dish, made with springy noodles, flavorful pork broth, and a variety of toppings, including sliced pork, boiled egg, and green onions. It is a hearty and satisfying meal option, and a favorite among our regular customers.', i: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&q=80', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-black tracking-tighter text-primary font-headline">Kolo mee stinablis</span>
          </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1521791136200-7c5d99ed5a4d?w=1200&q=80" alt="Hero" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold text-white leading-[1.1] mb-8 tracking-tighter">
              best kolo me <span className="text-accent">Excellence.</span>
            </h1>
            <p className="text-white/80 text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-light">
              Kolo mee stinablis delivers visionary solutions through sustainable design and uncompromising excellence.
            </p>
            <a
              href={`https://wa.me/0142899656`}
              target="_blank"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Kolo mee stinablis, we are dedicated to serving the best kolo mee dishes in town, using only the freshest ingredients and traditional recipes. Our team is passionate about delivering exceptional customer service and ensuring that every meal is a satisfying experience. With a focus on quality and customer satisfaction, we strive to be the go-to destination for kolo mee lovers.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To be the leading provider of delicious and authentic kolo mee dishes, renowned for our commitment to quality, customer satisfaction, and community engagement.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To serve the best kolo mee in town, while fostering a culture of excellence, customer-centricity, and continuous improvement, and making a positive impact on the local food scene.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer First</h4>
                  <p className="text-sm text-on-surface-variant">We prioritize our customers\' needs and preferences, ensuring that every interaction with our brand is a positive and memorable experience.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Quality</h4>
                  <p className="text-sm text-on-surface-variant">We are committed to serving only the highest-quality kolo mee dishes, made with the freshest ingredients and prepared with meticulous attention to detail.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1200&q=80" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&q=80" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=1200&q=80" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          <div>
            <div className="text-xl font-bold text-white mb-4">Kolo mee stinablis</div>
            <p className="text-white/60 text-sm leading-relaxed">best kolo me</p>
          </div>
          ...
          <div className="md:text-right">
            <p className="text-white/60 text-sm leading-relaxed">
              &copy; {new Date().getFullYear()} Kolo mee stinablis. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
